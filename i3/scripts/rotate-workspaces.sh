...
i3-msg rename workspace ${VISIBLE_WS[0]} to ${VISIBLE_WS[1]}
i3-msg rename workspace ${VISIBLE_WS[2]} to temp2
i3-msg rename workspace temp  to ${VISIBLE_WS[2]}
i3-msg rename workspace temp2 to ${VISIBLE_WS[0]}
